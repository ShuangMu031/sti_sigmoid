...
def registerTexture(img1, edge1, img2, edge2):
    """
    MATLAB 风格稳定 Homography 估计
    输出 H : img2 -> img1
    """

    # ==================================================
    # 1. Edge-masked SIFT（抹零，而不是 mask）
    # ==================================================
    ...
    # ==================================================
    # 4. Δx / Δy histogram filter（MATLAB matchDelete）
    # ==================================================
    pts1, pts2 = _histogram_filter(
        pts1, pts2,
        img1.shape,
        thr=config.HIST_SHIFT_BIN_RATIO
    )
